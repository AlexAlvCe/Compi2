...
public class LayoutVisitor implements Visitor {
  ...
  public Object visitIfCommand(IfCommand ast, Object obj) {
    ...
    return layoutNnary("IfCom.", childs);
  }
  ...
  private DrawingTree layoutNnary (String name, ArrayList<AST> childs) {
    DrawingTree dt = layoutCaption(name);
    DrawingTree[] dtChilds = new DrawingTree[childs.size()];
    
    for (int i=0;i<childs.size();i++) {
        dtChilds[i] = (DrawingTree) childs.get(i).visit(this, null);
    }    
    dt.setChildren(dtChilds);
    attachParent(dt, join(dt));
    return dt;
  }
  ...
  private Polyline bridge (Polyline line1, int x1, int y1,
    ...
    public Object visitForDoCommand(ForDo ast, Object o) {
        return layoutQuaternary("Repeat For Do.", ast.I,ast.E1,ast.E2,ast.C1);
    }
    ...
    public Object visitForWhileCommand(ForWhileCommand ast, Object o) {
        ...
        return layoutNnary("Repeat For While ", childs);
    }
    

    @Override
    public Object visitForInCommand(ForInCommand ast, Object o) {
          return layoutTernary("Repeat For In", ast.I, ast.E, ast.C);
    }

    @Override
    public Object visitCaseRange(CaseRange ast, Object o) {
         return layoutTernary("Casa Range", ast.T1, ast.T2, ast.C);
    }

    @Override
    public Object visitCaseLiteral(CaseLiteral ast, Object o) {
        return layoutBinary("Casa literal", ast.T, ast.C);
    }
    ...
    public Object visitCasesElse(CasesElse ast, Object o) {
        ...
        list.add(ast.C2);
        return layoutNnary("Cases", list);
    }

    @Override
    public Object visitSelectCommand(SelectCommand ast, Object o) {
        return layoutBinary("Cases", ast.E, ast.C);
    }
    ...
    public Object visitCasesCase(CasesCase ast, Object o) {
        ...
        return layoutNnary("Cases Case",list);
    }
    ...
    public Object visitcompoundDeclRecursive(compoundDeclRecursive ats, Object o) {
        return layoutUnary("Compound Declaration recursive", ats.P);
    }

    @Override
    public Object visitcompoundDeclLocal(compoundDeclLocal ast, Object o) {
        return layoutBinary("Compound Declaration local", ast.D1, ast.D2);
    }
    ...
    public Object visitSequentialDeclarationNnary(SequentialDeclarationNnary ast, Object o) {
        ...
        return layoutNnary("Sequential declaration",list);
    }
    ...
    public Object visitForUntilCommand(ForUntilCommand ast, Object o) {
        ArrayList<AST> childs = new ArrayList<>();
        childs.add(ast.I);childs.add(ast.E1);childs.add(ast.E2);childs.add(ast.E3);childs.add(ast.C1);
        return layoutNnary("Repeat For Until ", childs);
    }
