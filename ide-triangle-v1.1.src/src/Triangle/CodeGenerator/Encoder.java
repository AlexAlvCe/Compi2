...
public final class Encoder implements Visitor {
  ...
  public Object visitIfCommand(IfCommand ast, Object o) {
    ...
    Integer valSize = (Integer) ast.E.get(i).visit(this, frame);
    jumpifAddr = nextInstrAddr;
    emit(Machine.JUMPIFop, Machine.falseRep, Machine.CBr, 0);
    ast.C.get(i).visit(this, frame);
  ...
  public Object visitVarDeclaration(VarDeclaration ast, Object o) {
   ...
   @Override
    ...
    extraSize = ((Integer) ast.E.visit(this, null));
    emit(Machine.PUSHop, 0, 0, extraSize);
    ast.entity = new KnownAddress(Machine.addressSize, frame.level, frame.size);
    writeTableDetails(ast);
    return extraSize;
  ...
  @Override
    ...
    public Object visitCasesElse(CasesElse ast, Object o) {
        ...
        for (int i=0;i<ast.listC.size();i++) {
            ast.listC.get(i).visit(this, frame);
            patch(jumpAddr, nextInstrAddr);
