...
public final class Checker implements Visitor {
  ...
  public Object visitIfCommand(IfCommand ast, Object o) {    
    for (int i=0;i<ast.E.size();i++) {
      TypeDenoter eType = (TypeDenoter) ast.E.get(i).visit(this, null);
      if (! eType.equals(StdEnvironment.booleanType))
      reporter.reportError("Boolean expression expected here", "", ast.E.get(i).position);
  ...
  @Override
    ...
    public Object visitForWhileCommand(ForWhileCommand ast, Object o) {
        ...
        if (! eType.equals(StdEnvironment.booleanType))
          reporter.reportError("Boolean expression expected here", "", ast.E2.position);
        eType = (TypeDenoter) ast.E3.visit(this, null);        
        if (! eType.equals(StdEnvironment.booleanType))
